...
<head>
  ...
  <title>NexoraSkill | Course Payment</title>
...
<div class="application-container">
  <h1 class="hud-header">Course Payment</h1>

  <div class="form-toggle-container">
    <span class="form-toggle-label active" id="standardLabel">Standard Payment</span>
    <label class="cyber-toggle">
      <input type="checkbox" id="formToggle">
      <span class="cyber-slider"></span>
    </label>
    <span class="form-toggle-label" id="lateLabel">Late Fee Payment</span>
  </div>

  <!-- Standard Payment Form -->
  <form action="ProcessPayment" method="post" id="standardForm" class="form-section active">
    <input type="hidden" name="action" value="payment">
    <div>
      <div class="input-holofield">
        <label for="startDate">Course Start Date</label>
        <input type="date" id="startDate" name="startDate" class="holo-input" required>
      </div>

      <div class="input-holofield">
        <label for="studyMode">Preferred Study Mode</label>
        <select id="studyMode" name="studyMode" class="holo-input" required>
          <option value="" disabled selected>Select study mode</option>
      ...
      <div class="input-holofield">
        ...
        <input type="tel" id="emergencyContact" name="emergencyContact" class="holo-input" placeholder="Enter emergency contact number" required>
      </div>
    </div>
    ...
    <div>
      ...
      <button type="submit" class="submit-button">
        <i class="fas fa-rocket"></i> Process Payment
      </button>
    </div>
  </form>

  <!-- Late Fee Payment Form -->
  <form action="ProcessPayment" method="post" id="lateFeeForm" class="form-section">
    <input type="hidden" name="action" value="latefee">
    <div>
      <div class="input-holofield">
        <label for="lateStartDate">Course Start Date</label>
        <input type="date" id="lateStartDate" name="startDate" class="holo-input" required>
      </div>

      <div class="input-holofield">
        <label for="lateStudyMode">Preferred Study Mode</label>
        <select id="lateStudyMode" name="studyMode" class="holo-input" required>
          <option value="" disabled selected>Select study mode</option>
          <option value="online">Online</option>
          <option value="inperson">In-Person</option>
        </select>
      ...
      <div class="input-holofield">
        <label for="lateEmergencyContact">Emergency Contact Number</label>
        <input type="tel" id="lateEmergencyContact" name="emergencyContact" class="holo-input" placeholder="Enter emergency contact number" required>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="status-indicator warning">
        ...
        <span class="status-text">Late fee payment requires approval</span>
      </div>
      ...
      <div class="input-holofield">
        <label for="lateReason">Reason for Late Payment</label>
        <textarea id="lateReason" name="lateReason" class="holo-input" rows="4"
                  placeholder="Please explain your reason for paying after the deadline..." required></textarea>
      </div>

      <input type="hidden" name="amount" value="349">
      <button type="submit" class="submit-button">
        <i class="fas fa-paper-plane"></i> Process Late Payment
      </button>
    </div>
  </form>
</div>
